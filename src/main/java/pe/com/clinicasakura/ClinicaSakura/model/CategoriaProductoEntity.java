...
@Entity(name = "CategoriaProductoEntity")
@Table(name = "categoriaproducto")
public class CategoriaProductoEntity extends BaseEntity 
    ...
    @NotEmpty
    @Size(min = 5, max = 50, message = "El nombre de la categoria tiene que estar entre {min} y {max} caracteres")
